...
/**
 * 专门为Fragment显示vodListView自定义的Adapter适配器类,与ShowVodsInSelectedPpList中用到的VodAdapter不同
 */
public class FragmentVodAdapter extends BaseAdapter{
	...
	//构造方法
	public FragmentVodAdapter(LayoutInflater inflater,List<PpVodItem> vodItems) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convertView = inflater.inflate(R.layout.adapter_showvods_info_item, null);
		//获取各个控件
		...
		if(wantShowVod.getVod_pic() == null ||wantShowVod.getVod_pic().equals("")){
			vod_picView.setImageResource(R.drawable.img404);//设置为默认提供的“img404找不到”
		}else{
