...
public class PlayLikesItemAdapter extends BaseAdapter {

	public Context context;
	public List<PlayLikesItem> likesItems;
	private OperateDAO dao;
	
	public PlayLikesItemAdapter(Context context,
			List<PlayLikesItem> likesItems) {
		super();
	...
	public int getCount() {
		...
		return likesItems.size();
	}

	@Override
	public Object getItem(int arg0) {
		// TODO Auto-generated method stub
		return likesItems.get(arg0);
	}

	@Override
	public long getItemId(int arg0) {
		// TODO Auto-generated method stub
		return Integer.parseInt(likesItems.get(arg0).getLikes_id());
	}

	@Override
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		PlayLikesItem wantShowLikesItem = likesItems.get(position);
		PpVodItem wantShowVod = dao.getVodByVod_id(wantShowLikesItem.getVod_id());
		convertView = LayoutInflater.from(context).inflate(R.layout.adapter_show_playlikes_info_item, null);
		//获取playtime
